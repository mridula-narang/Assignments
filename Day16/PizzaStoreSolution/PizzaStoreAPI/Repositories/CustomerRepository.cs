...
namespace PizzaStoreAPI.Repositories
{
    public class CustomerRepository : IRepository<int, Customer>
    {
        ...
        {
            new Customer { Id = 1, Name = "Harry",Email = "harry.potter@gmail.com" , Phone = 1234567890 },
            new Customer { Id = 2, Name = "Hermione",Email = "hermione.granger@gmail.com", Phone = 6789589475 },
        };
